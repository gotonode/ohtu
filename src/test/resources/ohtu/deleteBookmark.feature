Feature: User can delete a bookmark of type blogpost by given id (US3, US13)
  ...
  Scenario: user can delete a blogpost by giving existed id and a confirmation (US3)
  ...
  Scenario: user can delete a video by giving existed id and a confirmation (US3)
  ...
  Scenario: user can delete a book by giving existed id and a confirmation (US3)
